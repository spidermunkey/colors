// import { collections, indexes } from "../../data/color-fakeDB.js";
let errorLog = [];
...
// returns a color with props + render method
/* TLDR;
 {
    color: { ...props }
    render()
...
class Model {
    constructor(map) {
        // ?adapter/decorator/factory? => forEach(index) => new Palette()
...
export const model = (indexes) => new Model(indexes);
