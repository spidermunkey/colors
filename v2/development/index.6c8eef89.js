...
function deconstruct_HSL_String(strVal) {
    return color.replace("hsla", "").replace("(", "").replace(")", "").replace("deg", "").replaceAll("%", "").split(",").map(Number);
}
...
//     return true;
// }
function getContrast(color1) {
    // https://stackoverflow.com/questions/1855884/determine-font-color-based-on-background-color
    let d = 0;
    let [r, g, b] = color1.rgb;
    // let [h,s,l] = color.hsl;
...
//# sourceMappingURL=index.6c8eef89.js.map
