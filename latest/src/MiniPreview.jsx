...
export const MiniPreview = ({selected,state,setState,toggleEditor}) => {
  ...
  return (
      <div id='mini-preview' className={state !== 'active' && 'active'}>
        ...
        <div className="fs icon" onClick={() => toggleEditor(selected)}>
            <OpenFullScreen/>
          </div>
        </div>
        </div>
